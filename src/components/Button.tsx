...
const Button = ({icon, children, href, containerClassName, onClick, markerFill}: {markerFill?:string; icon: string, children: ReactNode, href?: boolean, containerClassName?: string, onClick?: () => void}) => {
    const Inner = () => (
        <>
    ...
    return href ? (
    <a className={clsx('rerelative p-0.5 g5 rounded-2xl shadow-500 group', containerClassName)} href="">
        <Inner />
    </a>
  ): (
