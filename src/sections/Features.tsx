            ...
            <div className="container">
                <div className="relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3">
                        ...
                        <div key={id} className='relative z-2 md:px-10 px-5 md:pb-10 pb-5 flex-50 max-md:g7 max-md:border-2 max-md:border-s3 max-md:rounded-3xl max-md:flex-320'>
                            <div className='w-full flex justify-start items-start'>
                                <div className="-ml-3 mb-12 flex items-center justify-center flex-col">
                                    <div className='w-0.5 h-16 bg-s3 ' aria-hidden/>
                    ...
                    <ul className='relative flex justify-around flex-grow px-[5%] border-2 border-s3 rounded-7xl max-md:hidden'>
                        <div className='absolute bg-s3/20 top-[38%] left-0 right-0 w-full h-[1px] z-10' aria-hidden />
                        {details.map(({ id, icon, title }) => (
                            <li key={id} className='relative pt-16 px-4 pb-14'>
                                <div className='absolute top-1 bottom-0 left-1/2 bg-s3/20 w-[1px] h-full z-10'/>
                                ...
                                <h3 className='relative z-2 max-w-36 mx-auto base-small text-center uppercase'>{title}</h3>
                            </li>
                        ))}
                    </ul>
                </div>
